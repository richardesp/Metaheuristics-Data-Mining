...
def main():
    ...
    print("Ejecutando primer genético")
    basic_genetic(7, sub_patterns_n_solutions, 100, .7, .4, 3, first_genetic)

    print("Ejecutando segundo genético")
    basic_genetic(8, sub_patterns_n_solutions, 100, .7, .4, 3, second_genetic)
